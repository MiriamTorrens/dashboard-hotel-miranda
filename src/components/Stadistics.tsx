...
import { select, scaleBand, axisBottom, axisRight, axisLeft, scaleLinear, scaleOrdinal } from "d3";
  ...
  useEffect(() => {
    ...
    //Añadir barras
      svg
        ...
        .attr("y", (d) => d.key === "sales" ? yScaleLeft(d.value) : yScaleRight(d.value))
        .attr("width", xSubgroup.bandwidth())
        .attr("height", (d) => d.key === "sales" ? height - yScaleLeft(d.value) : height - yScaleRight(d.value))
...
const data = [
    { day: 'Sunday', sales: 4000, occupancy: 60},
    { day: 'Monday', sales: 600, occupancy: 20 },
    { day: 'Tuesday', sales: 510, occupancy: 15 },
    { day: 'Wednesday', sales: 3050, occupancy: 52 },
    { day: 'Thursday', sales: 4600, occupancy: 70 },
    { day: 'Friday', sales: 4700, occupancy: 80 },
    { day: 'Saturday', sales: 780, occupancy: 30 },
];