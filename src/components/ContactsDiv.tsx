...
import ModalContact from './ModalContact.tsx';
import { ContactObject } from '../services/types.d';
...
export default function ContactsDiv(){
    ...
    const contactList:ContactObject[] = useSelector(allContact);
    const [open, setOpen] = useState("none");
    const [message, setMessage] = useState({});
    
    const handleClick = (contact: ContactObject) => {
      setOpen("block");
      setMessage(contact);
    };
